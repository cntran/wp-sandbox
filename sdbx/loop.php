...
<?php if ( ! have_posts() ) : ?>
	<div id="post-0" class="post error404 not-found">
		<h1 class="entry-title"><?php _e( 'Not Found', 'sdbx' ); ?></h1>
		<div class="entry-content">
			<p><?php _e( 'Apologies, but no results were found for the requested archive. Perhaps searching will help find a related post.', 'sdbx' ); ?></p>
			<?php get_search_form(); ?>
		</div><!-- .entry-content -->
	</div><!-- #post-0 -->
<?php endif; ?>
...
<?php /* How to display posts in the Gallery category. */ ?>
	...
	<?php if ( in_category( _x('gallery', 'gallery category slug', 'sdbx') ) ) : ?>
...
<?php else : ?>			
				...
				?>
						...
						<p><em><?php printf( __( 'This gallery contains <a %1$s>%2$s photos</a>.', 'sdbx' ),
								'href="' . get_permalink() . '" title="' . sprintf( esc_attr__( 'Permalink to %s', 'sdbx' ), the_title_attribute( 'echo=0' ) ) . '" rel="bookmark"',
								$total_images
							); ?></em></p>
				<?php endif; ?>
						<?php the_excerpt(); ?>
<?php endif; ?>
			...
			<div class="entry-utility">
				<a href="<?php echo get_term_link( _x('gallery', 'gallery category slug', 'sdbx'), 'category' ); ?>" title="<?php esc_attr_e( 'View posts in the Gallery category', 'sdbx' ); ?>"><?php _e( 'More Galleries', 'sdbx' ); ?></a>
...
<?php /* How to display posts in the asides category */ ?>
	...
	<?php elseif ( in_category( _x('asides', 'asides category slug', 'sdbx') ) ) : ?>
		<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
		...
		<?php else : ?>
			<div class="entry-content">
				<?php the_content( __( 'Continue reading <span class="meta-nav">&rarr;</span>', 'sdbx' ) ); ?>
			</div><!-- .entry-content -->
		<?php endif; ?>
